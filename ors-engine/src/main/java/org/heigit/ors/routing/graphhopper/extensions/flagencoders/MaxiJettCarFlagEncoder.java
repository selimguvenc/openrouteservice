 ...
 * @author Nop
 */
public class MaxiJettCarFlagEncoder extends VehicleFlagEncoder {
    ...
    public MaxiJettCarFlagEncoder(PMap properties) {
    ...
    public MaxiJettCarFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
    ...
    public String toString() {
        return FlagEncoderNames.MAXIJETT_CAR;
    }
