...
public class RequestOptions implements RouteRequestParameterNames {
    ...
    @Schema(name = PARAM_AVOID_FEATURES, description = "List of features to avoid. ",
            extensions = {@Extension(name = "itemRestrictions", properties = {
                    ...
                    @ExtensionProperty(name = "itemsWhen", value = "{\"driving-*\":[\"highways\",\"tollways\",\"ferries\"],\"maxijett-*\":[\"highways\",\"tollways\",\"ferries\"],\"cycling-*\":[\"ferries\",\"steps\",\"fords\"],\"foot-*\":[\"ferries\",\"fords\",\"steps\"],\"wheelchair\":[\"ferries\",\"steps\"]}", parseValue = true)}
            )},
            example = "[\"highways\"]")
